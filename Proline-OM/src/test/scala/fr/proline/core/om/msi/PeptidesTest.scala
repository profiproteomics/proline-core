...
class PeptidesTest extends JUnitSuite with Logging {
    ...
    def testGetPeptideMatchIDs() = {
	  ...
	  val pepMatch1 = new PeptideMatch( id = 1, rank=1, score = 45.5f, scoreType="Mascot", deltaMoz=0.05f, isDecoy= false, peptide=pep1,missedCleavage=1  )
	  val pepMatch2 = new PeptideMatch( id = 2, rank=2, score = 13.21f, scoreType="Mascot", deltaMoz=0.15f, isDecoy= false, peptide=pep1,missedCleavage=1 )
