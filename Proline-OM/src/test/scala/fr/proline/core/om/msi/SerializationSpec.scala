...
class SerializationSpec extends AbstractSerializationSpec {
  ...
  val jsonSpecifs = List(
    ...
    SerializationSpecif(
      ...
      peptide,
      """{"id":-1,"sequence":"MENHIR","ptm_string":"1[O]","calculated_mass":814.3806572,"readable_ptm_string":"Oxidation (M1)"}"""
    ),
    SerializationSpecif(
    ...
    SerializationSpecif(
      ...
      """"score_type":"mascot:standard score","peptide_matches_count":0,"sequence_matches":"""+
