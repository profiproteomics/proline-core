...
class AbundanceSummarizerTest {
  ...
  def testSummarizeUsingBestScore {
    intercept[IllegalArgumentException] {
      summarizeAbundanceMatrix(matrixWithMissingValues, MqPeptideAbundanceSummarizingMethod.BEST_SCORE)
    }
  }

  @Test
  def testSummarizeUsingMaxAbundanceSum {
    val singleRow = summarizeAbundanceMatrix(matrixWithMissingValues, MqPeptideAbundanceSummarizingMethod.MAX_ABUNDANCE_SUM)
    assertArrayEquals(Array(3.99E+08f, Float.NaN, Float.NaN, 3.90E+08f), singleRow, 3.99E+08f * 0.01f)
  }

  @Test
  def testSummarizeUsingMean {
    val singleRow = summarizeAbundanceMatrix(matrixWithMissingValues, MqPeptideAbundanceSummarizingMethod.MEAN)
    assertArrayEquals(Array(2.24E+08f, Float.NaN, 1.74E+08f, 1.96E+08f), singleRow, 2.24E+08f * 0.01f)
  }

  @Test
  def summarizeUsingMeanOfTop3 {
    val singleRow = summarizeAbundanceMatrix(matrixWithMissingValues, MqPeptideAbundanceSummarizingMethod.MEAN_OF_TOP3)
    assertArrayEquals(Array(2.82E+08f, Float.NaN, 2.35E+08f, 2.68E+08f), singleRow, 2.82E+08f * 0.01f)
  }

  @Test
  def summarizeUsingMedian {
    val singleRow = summarizeAbundanceMatrix(matrixWithMissingValues, MqPeptideAbundanceSummarizingMethod.MEDIAN)
    assertArrayEquals(Array(2.24E+08f, Float.NaN, 1.45E+08f, 1.46E+08f), singleRow, 2.24E+08f * 0.01f)
  }

  @Test
  def summarizeUsingMedianProfile {
    val singleRow = summarizeAbundanceMatrix(matrixWithMissingValues, MqPeptideAbundanceSummarizingMethod.MEDIAN_PROFILE)
    assertArrayEquals(Array(2.82E+08f, Float.NaN, 2.94E+08f, 2.99E+08f), singleRow, 2.82E+08f * 0.01f)
  }

  @Test
  def summarizeUsingMedianProfile2: Unit = {
    val matrix = Array(
      Array(4E+08f, 4E+08f, 4.5E+08f, 3.5E+08f),
      Array(3E+08f, 3E+08f, 3E+08f, 3E+08f),
  ...
  def summarizeUsingSum {
    val singleRow = summarizeAbundanceMatrix(matrixWithMissingValues, MqPeptideAbundanceSummarizingMethod.SUM)
