...
public abstract class AbstractDSConnectorFactory implements IDataStoreConnectorFactory {
	 ...
	 */
	protected abstract IDatabaseConnector createProjectDatabaseConnector(
...
//			initialize(createDatabaseConnector(ProlineDatabaseType.UDS, udsDbPropertiesFileName), applicationName);
	...
	public void closeAll() {
		synchronized (m_managerLock) {
			...
			/* Reverse order of Dbs creation : LCMS, MSI, UDS */
