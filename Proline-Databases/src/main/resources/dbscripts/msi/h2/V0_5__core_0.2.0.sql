...
ALTER TABLE public.result_summary_object_tree_map DROP CONSTRAINT result_summary_result_summary_property_fk;
ALTER TABLE public.result_summary_object_tree_map DROP PRIMARY KEY;
...
ALTER TABLE public.protein_set_object_tree_map DROP CONSTRAINT protein_set_protein_set_object_tree_map_fk;
ALTER TABLE public.protein_set_object_tree_map DROP PRIMARY KEY;
...
ALTER TABLE public.msi_search_object_tree_map DROP PRIMARY KEY;
...
ALTER TABLE public.peptide_match_object_tree_map DROP CONSTRAINT peptide_match_peptide_match_object_tree_map_fk;
ALTER TABLE public.peptide_match_object_tree_map DROP PRIMARY KEY;
...
ALTER TABLE public.result_set_object_tree_map DROP CONSTRAINT result_set_result_set_properties_fk;
ALTER TABLE public.result_set_object_tree_map DROP PRIMARY KEY;
