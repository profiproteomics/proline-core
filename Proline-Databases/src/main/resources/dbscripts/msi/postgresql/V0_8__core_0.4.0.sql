...
INSERT INTO scoring (search_engine,name,description) VALUES ('comet', 'evalue log scaled', 'The -log(expectation value) provided by Comet for a peptide match.');
INSERT INTO scoring (search_engine,name,description) VALUES ('msgf', 'evalue log scaled', 'The -log(EValue) provided by MS-GF for a peptide match.');
INSERT INTO scoring (search_engine,name,description) VALUES ('sequest', 'expect log scaled', 'The -log(expect) provided by Sequest for a peptide match.');
INSERT INTO scoring (search_engine,name,description) VALUES ('xtandem', 'hyperscore', 'The hyperscore provided by X!Tandem for a peptide match.');
