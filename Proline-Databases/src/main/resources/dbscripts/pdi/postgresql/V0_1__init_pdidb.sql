...
CREATE TABLE public.fasta_parsing_rule (
                id INTEGER NOT NULL DEFAULT nextval('public.fasta_parsing_rule_id_seq'),
                db_type VARCHAR(100),
...
COMMENT ON COLUMN public.seq_db_instance.is_native IS 'A native DB is a public DB which is neither a subset of database neither a database with additionnal or modified sequences (i.e. decoy sequences).';
...
CREATE TABLE public.taxon (
                id INTEGER NOT NULL DEFAULT nextval('public.taxon_id_seq'),
...
CREATE TABLE public.gene (
                id INTEGER NOT NULL DEFAULT nextval('public.gene_id_seq'),
                name VARCHAR(100) NOT NULL,
                synonyms TEXT,
                orf_names TEXT,
...
CREATE TABLE public.chromosome_location (
                id INTEGER NOT NULL DEFAULT nextval('public.chromosome_location_id_seq'),
...
CREATE TABLE public.bio_sequence (
                id INTEGER NOT NULL DEFAULT nextval('public.bio_sequence_id_seq'),
                alphabet CHAR(3) NOT NULL,
...
CREATE TABLE public.bio_sequence_annotation (
                id INTEGER NOT NULL DEFAULT nextval('public.bio_sequence_annotation_id_seq'),
