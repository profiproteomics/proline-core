...
CREATE TABLE public.aggregation (
                id INTEGER NOT NULL DEFAULT nextval('public.aggregation_id_seq'),
...
CREATE TABLE public.fractionation (
                id INTEGER NOT NULL DEFAULT nextval('public.fractionation_id_seq'),
...
CREATE TABLE public.fragmentation_series (
                id INTEGER NOT NULL DEFAULT nextval('public.fragmentation_series_id_seq'),
                name VARCHAR(9),
...
CREATE TABLE public.sample_analysis (
                id INTEGER NOT NULL DEFAULT nextval('public.sample_analysis_id_seq'),
                number INTEGER NOT NULL,
                serialized_properties TEXT,
