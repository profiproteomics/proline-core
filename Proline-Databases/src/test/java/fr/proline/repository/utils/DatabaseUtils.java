...
public class DatabaseUtils {
    ...
    private static void _createSQLiteDB(DatabaseTestConnector connector, InputStream scriptIS)
	    throws Exception {
    ...
    public static void writeDataSetXML(DatabaseTestConnector connector, String outputFilename)
	    throws Exception {
    ...
    public static void loadCompositeDataSet(DatabaseTestConnector connector, String[] datasetNames)
	    throws Exception {
	IDatabaseTester databaseTester = connector.getDatabaseTester();
	DataFileLoader dataLoader = new FlatXmlDataFileLoader();
