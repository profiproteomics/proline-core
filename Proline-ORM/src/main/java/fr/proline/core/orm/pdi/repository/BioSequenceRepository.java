...
public class BioSequenceRepository extends JPARepository {
	...
	protected static Logger logger = LoggerFactory.getLogger(BioSequenceRepository.class);
	...
	public BioSequence findBioSequencePerAccessionAndSeqDB(String accession, Integer seqDbInstanceId) {
		TypedQuery<BioSequence> query = getEntityManager()
				.createQuery("Select bs from fr.proline.core.orm.pdi.BioSequence bs, fr.proline.core.orm.pdi.ProteinIdentifier pi, fr.proline.core.orm.pdi.SequenceDbEntry se, fr.proline.core.orm.pdi.SequenceDbInstance si, fr.proline.core.orm.pdi.DbEntryProteinIdentifierMap dbepi"
		...
		try {
			...
			logger.info(
					" No BioSequence for accession {} and SequenceDbInstance {} ",
