...
public class UncachedDataStoreConnectorFactoryTest extends DatabaseTestCase {

	private static final Logger LOG = LoggerFactory.getLogger(UncachedDataStoreConnectorFactoryTest.class);
	...
	public void testDatabaseManager() {
		final UncachedDataStoreConnectorFactory connectorFactory = UncachedDataStoreConnectorFactory.getInstance();
	...
	public void tearDown() {
		...
		UncachedDataStoreConnectorFactory.getInstance().closeAll();
	}
