...
public class MsiPeptideTest extends DatabaseTestCase {
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(MsiPeptideTest.class);
	...
	public void setUp() throws Exception {
		initDatabase();
		initEntityManager(JPAUtil.PersistenceUnitNames.MSI_Key
	...
	public void testMsiPeptideRepository() {
		...
		try {
			...
			final MsiPeptideRepository msiPeptideRepo = new MsiPeptideRepository(
					msiEm);
