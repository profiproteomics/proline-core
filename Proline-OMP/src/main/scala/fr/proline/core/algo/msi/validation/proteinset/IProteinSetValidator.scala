...
//   * 
//   */
//  def applyComputedProteinSetFilter( filter: ComputedFDRProteinSetFilter,
//                      targetDecoyMode: Option[TargetDecoyModes.Mode] ): ValidationResults

  def validateWithComputerParams( proteinSetsFilter: IProteinSetFilter,
