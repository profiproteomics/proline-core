...
trait IIsotopicPatternPredictor {
	...
	def isMatchReliable(spectrumData: SpectrumData, ppm: Float, moz: Double, charge: Int, mozTolInDa: Double): Boolean = {
      ...
      val putativePatterns = IsotopicPatternScorer.calclIsotopicPatternHypotheses(spectrumData, moz, ppm)
   ...
   def getBestExplanation(
    ...
    mozTolInDa: Double): (Double, TheoreticalIsotopePattern) = {
     ...
     val apexMz = peakel.getApexMz
        ...
        val putativePatterns = IsotopicPatternScorer.calclIsotopicPatternHypotheses(sliceOpt.get.getData(), peakel.getApexMz(), ppm)
...
object PeakelsPatternPredictor extends IIsotopicPatternPredictor {
  ...
  def getBestExplanation(
    ...
    mozTolInDa: Double): (Double, TheoreticalIsotopePattern) = {
      ...
      val putativePatterns = IsotopicPatternScorer.calclIsotopicPatternHypotheses(spectrumData, peakel.getApexMz(), mozTolPPM)
      putativePatterns.head
  }
